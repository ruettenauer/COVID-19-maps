...
# Total cases on recent date
sum(germany_covid.df$sum_cases[germany_covid.df$date == max(germany_covid.df$date)], na.rm = TRUE)
...
# All pictures
files <- paste0("../03_Output/", "Germany_cases_", dates[dates >= "2020-03-01"], ".png")
